...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		Mockito.when(c2.getId()).thenReturn(2); //When c2.getId is called, mockito will return 2
		...
		Mockito.when(c3.getId()).thenReturn(3); //When c3.getId is on then return 3
		Mockito.when(c3.getName()).thenReturn("Mistoffelees"); //when getName is called on c3 Mistoffelees
	...
	public void testGetCatNumCats3() {
		...
		//Open debug console to see any printn
	...
	public void testCatAvailableFalseNumCats0() {
		// TODO
		assertFalse("Returned Cat is True", r.catAvailable(2));
	}
	...
	public void testCatExistsFalseNumCats0() {
		...
		assertFalse("CAT DOES EXISt", r.catExists(2));
	}
	...
	public void testListCatsNumCats0() {
		// TODO
		assertEquals("These are not equal", "", r.listCats());
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("The cat was rented", r.rentCat(2));
	}
	...
	public void testReturnCatFailureNumCats0() {
		...
		assertFalse("rent Cat does not return false", r.returnCat(2));
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("Cat was not returned", r.returnCat(2));

		Mockito.verify(c2, atLeast(1)).returnCat();
		Mockito.verify(c1,Mockito.times(0)).rentCat();
		Mockito.verify(c3,Mockito.times(0)).rentCat();
	}
}